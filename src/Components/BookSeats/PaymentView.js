...
const STRIPE_PK = "sk_test_51PrYcXLTXy6ka4zMGRYshp34EbYBTClaCz7W7qBZlPRX8lF074vqCMs5756CuEsjhqQ8ZSaWRx0CyFwdO4ADd0rq00VogtKiup";
...
const PaymentView = (props) => {
  ...
  const onMessage = (event) => {
    try {
      ...
      console.log('Received data from WebView:', parsedData);
      onCheckStatus(parsedData);
    } catch (error) {
